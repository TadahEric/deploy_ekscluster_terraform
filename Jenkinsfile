pipeline {
    ...
    environment {
        EMAIL_TO = 'eric.tadah88@gmail.com'
    }
    stages {
        ...
        stage ('5. Email Notification') {
            steps {
               mail bcc: 'eric.tadah88@gmail.com', body: '''Terraform deployment is completed.
               Let me know if the changes look okay.
               Thanks,
               Dominion System Technologies,
              +1 (313) 413-1477''', cc: 'eric.tadah88@gmail.com', from: '', replyTo: '', subject: 'Terraform Infra deployment completed!!!', to: 'eric.tadah88@gmail.com'
