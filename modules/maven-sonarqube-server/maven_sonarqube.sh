...
sudo certbot --nginx -d sonarqube.evolutionsystems.org --email eric.tadah88t@gmail.com --non-interactive --agree-tos --redirect
...
echo "sonarqube is now accessible via https://sonarqube.evolutionsystems.org"
